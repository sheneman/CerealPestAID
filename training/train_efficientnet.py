...
MODEL_STATE_PATH = os.path.join(MODEL_SAVE_PATH, 'best_factai_efficientnet-b6.pth')
...
EFFICIENTNET_MODEL = "efficientnet-b6"
...
model = EfficientNet.from_pretrained(EFFICIENTNET_MODEL)

# Load the state_dict and inspect it to determine the number of classes
